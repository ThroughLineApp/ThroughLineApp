      ...
      <div style={{
        ...
        {feedLoading ? (
          ...
          <div style={{
            ...
            <svg width={32} height={32} viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 12, display: "block", margin: "0 auto 12px" }}>
